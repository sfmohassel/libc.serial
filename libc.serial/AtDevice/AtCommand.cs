...
namespace libc.serial.AtDevice {
    public abstract class AtCommand {
        ...
        private const int updateDataTimeout = 100;
        protected AtCommand() {
            timeout = new ATask(onTimeout, 1);
        ...
        private readonly WorkerThread updateThread;
        ...
        private readonly ATask timeout;
